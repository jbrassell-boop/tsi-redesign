...
router.post('/Supplier/AddSupplier', async (req, res, next) => {
  try {
    ...
    const result = await db.query(`
      ...
      {
        name1: b.sSupplierName1 || b.psSupplierName1 || '',
        name2: b.sSupplierName2 || b.psSupplierName2 || '',
        mailAddr1: b.sMailAddr1 || b.psAddress1 || '',
        mailAddr2: b.sMailAddr2 || b.psAddress2 || '',
        mailCity: b.sMailCity || b.psCity || '',
        mailState: b.sMailState || b.psState || '',
        mailZip: b.sMailZip || b.psZipCode || '',
...
router.post('/Supplier/UpdateSupplier', async (req, res, next) => {
  try {
    ...
    await db.query(`
      ...
      {
        supplierKey,
        name1: b.sSupplierName1 || b.psSupplierName1 || null,
        name2: b.sSupplierName2 || b.psSupplierName2 || null,
        mailAddr1: b.sMailAddr1 || b.psAddress1 || null,
        mailAddr2: b.sMailAddr2 || b.psAddress2 || null,
        mailCity: b.sMailCity || b.psCity || null,
